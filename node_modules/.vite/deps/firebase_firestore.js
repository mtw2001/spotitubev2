...
var Rt = class {
  constructor(t2, e) {
     ...
     */
    this.v = new q2(), this.transaction.oncomplete = () => {
      this.v.resolve();
...
var ks = class {
  constructor() {
     ...
     */
    this.vt = Fs(), /** See public getters for explanations of these fields. */
    this.Pt = Ht.EMPTY_BYTE_STRING, this.Vt = false, /**
    ...
    this.forEachTarget(t2, (e) => {
      ...
      switch (t2.state) {
        case 0:
          ...
          break;
        case 1:
          n.$t(), n.Dt || // We have a freshly added target, so we need to reset any state
  ...
  Qn(t2, e) {
    ...
    return n.X({
      ...
      0 === t3 ? (
        ...
        (i !== Ot.at && e(new ct(Ai(s)), i), // set nextToReport to be this sequence number. It's the next one we
  ...
  getDocumentsMatchingQuery(t2, e, n, s) {
    ...
    return yo(t2).W(IDBKeyRange.bound(r, o, true)).next((t3) => {
      ...
      for (const i2 of t3) {
        ...
        t4.isFoundDocument() && (Pn(e, t4) || s.has(t4.key)) && // Either the document matches the given query, or it is mutated.
...
var vo = class {
  constructor() {
    this.rs = new Ye(Po.os), // A set of outstanding references to a document sorted by target id.
...
var $o = class {
  constructor(t2, e, n, s, i, r, o, u, c, a, h = 15) {
    ...
    this.ri = (t3) => Promise.resolve(), !$o.C())
  ...
  async shutdown() {
    this.xs = false, this.bi(), this.si && (this.si.cancel(), this.si = null), this.vi(), this.Pi(), // Use `SimpleDb.runTransaction` directly to avoid failing if another tab
  ...
  li() {
    ...
    "function" == typeof (null === (t2 = this.window) || void 0 === t2 ? void 0 : t2.addEventListener) && (this.ei = () => {
      this.bi(), isSafari() && navigator.appVersion.match(/Version\/1[45]/) && // On Safari 14 and 15, we do not run any cleanup actions as it might
...
var Ko = class {
   ...
   */
  qi(t2, e, n, s) {
    return this.Oi.getDocumentsMatchingQuery(t2, n, s).next((t3) => (
...
var Go = class {
  constructor(t2, e, n, s) {
     ...
     */
    this.Qi = /* @__PURE__ */ new Map(), this.ji = t2.getRemoteDocumentCache(), this.Ns = t2.getTargetCache(), this.Os = t2.getBundleCache(), this.zi(n);
  }
  zi(t2) {
...
class {
  ...
  yo(t2, e, n) {
    ...
    this.useFetchStreams && (o.xmlHttpFactory = new FetchXmlHttpFactory({})), this._o(o.initMessageHeaders, e, n), // Sending the custom headers we just added to request.initMessageHeaders
    ...
    return f(c, WebChannel.EventType.OPEN, () => {
      ...
      if (!h) {
        ...
        if (i2) {
          ...
          h = true, l2.oo(new L2(e3, n3)), c.close();
        } else
...
var bu = class {
  constructor(t2, e, n, s, i, r, o, u) {
     ...
     * close.
     */
    this.Co = 0, this.xo = null, this.No = null, this.stream = null, this.ko = new Ru(t2, e);
  }
  /**
  ...
  async close(t2, e) {
    ...
    this.Co++, 4 !== t2 ? (
      ...
      (x2(e.toString()), x2("Using maximum backoff delay to prevent overloading the backend."), this.ko.bo())
...
function Ou(t2, e) {
  const n = $(t2), s = ic2(n);
  n.wu.delete(e), s.Mo() && Fu(n, e), 0 === n.wu.size && (s.Mo() ? s.Bo() : Lu(n) && // Revert to OnlineState.Unknown if the watch stream is not open and we
...
async function Ku(t2, e) {
  qu(t2), // If we still need the watch stream, retry the connection.
  Bu(t2) ? (t2.pu.fu(e), $u(t2)) : (
...
async function tc2(t2, e, n) {
  ...
  await ju(t2, () => t2.remoteSyncer.applySuccessfulWrite(i)), // It's possible that with the completion of this mutation another
  // slot has freed up.
  await zu(t2);
}
async function ec2(t2, e) {
  e && rc2(t2).Xo && // This error affects the actual write.
  await async function(t3, e2) {
    if (n = e2.code, ds(n) && n !== B2.ABORTED) {
      const n2 = t3._u.shift();
      rc2(t3).$o(), await ju(t3, () => t3.remoteSyncer.rejectFailedWrite(n2.batchId, e2)), // It's possible that with the completion of this mutation
...
function ic2(t2) {
  ...
  (t2.Tu = function(t3, e, n) {
    ...
    e ? (t2.Tu.$o(), Bu(t2) ? $u(t2) : t2.pu.set(
      "Unknown"
      /* OnlineState.Unknown */
    )) : (await t2.Tu.stop(), qu(t2));
  })), t2.Tu;
}
function rc2(t2) {
  ...
  (t2.Eu = function(t3, e, n) {
    ...
    e ? (t2.Eu.$o(), // This will start the write stream if necessary.
    await zu(t2)) : (await t2.Eu.stop(), t2._u.length > 0 && (C2("RemoteStore", `Stopping write stream with ${t2._u.length} pending writes`), t2._u = []));
  })), t2.Eu;
}
var oc2 = class {
  constructor(t2, e, n, s, i) {
...
var Tc2 = class {
  constructor(t2, e, n) {
    this.$u = t2, this.localStore = e, this.Tt = n, /** Batched queries to be saved into storage */
    this.queries = [], /** Batched documents to be saved into storage */
    this.documents = [], /** The collection groups affected by this bundle. */
    this.collectionGroups = /* @__PURE__ */ new Set(), this.progress = Ec2(t2);
  }
  /**
...
var bc2 = class {
  constructor(t2, e) {
    ...
    this.mutatedKeys = vs(), this.ju = Sn(t2), this.zu = new cc2(this.ju);
  }
  /**
  ...
  Hu(t2, e) {
    ...
    if (t2.inorderTraversal((t3, e2) => {
      const a = s.get(t3), h = Pn(this.query, e2) ? e2 : null, l2 = !!a && this.mutatedKeys.has(a.key), f = !!h && (h.hasLocalMutations || // We only consider committed mutations for documents that were
...
var Vc2 = class {
  constructor(t2, e, n, s, i, r) {
    this.localStore = t2, this.remoteStore = e, this.eventManager = n, this.sharedClientState = s, this.currentUser = i, this.maxConcurrentLimboResolutions = r, this.rc = {}, this.oc = new ws((t3) => bn(t3), Rn), this.uc = /* @__PURE__ */ new Map(), /**
...
async function Oc2(t2, e, n) {
  ...
  if (r) {
    ...
    await Nc2(s, i2), // Since this query failed, we won't want to manually unlisten to it.
    // We only remove it from bookkeeping after we successfully applied the
    // RemoteEvent. If `applyRemoteEvent()` throws, we want to re-listen to
    // this query when the RemoteStore restarts the Watch stream, which should
    // re-trigger the target failure.
    s.ac = s.ac.remove(r), s.hc.delete(e), Qc2(s);
  } else
    await Xo(
      s.localStore,
      e,
...
async function Mc2(t2, e) {
  ...
  try {
    ...
    Lc2(
      ...
      /*error=*/
      null
    ), Bc2(n, s), n.sharedClientState.updateMutationState(s, "acknowledged"), await jc2(n, t3);
  } catch (t3) {
    await Et(t3);
  }
}
...
async function zc2(t2, e) {
  ...
  if (!n.currentUser.isEqual(e)) {
    ...
    n.sharedClientState.handleUserChange(e, t3.removedBatchIds, t3.addedBatchIds), await jc2(n, t3.Wi);
  }
}
function Wc2(t2, e) {
...
async function Yc2(t2, e, n, s) {
  ...
  null !== r ? ("pending" === n ? (
    ...
    // other clients.
    (Lc2(i, e, s || null), Bc2(i, e), function(t3, e2) {
...
async function Zc2(t2, e) {
  ...
  if (ia2(n), ra2(n), true === e && true !== n.wc) {
    ...
    }), await e2, await Xc2(n, t3), // PORTING NOTE: Multi-Tab only.
    function(t4) {
      const e3 = $(t4);
      e3.hc.forEach((t5, n2) => {
...
var ca2 = class extends ua2 {
  ...
  async initialize(t2) {
    await super.initialize(t2), await this.bc.initialize(this, t2), // Enqueue writes from a previous session
    await ra2(this.bc.syncEngine), await zu(this.bc.remoteStore), // NOTE: This will immediately call the listener, so we make sure to
...
var aa2 = class extends ca2 {
  constructor(t2, e) {
    super(
      ...
      /* forceOwnership= */
      false
    ), this.bc = t2, this.cacheSizeBytes = e, this.synchronizeTabs = true;
  }
  async initialize(t2) {
...
var ha2 = class {
  async initialize(t2, e) {
    this.localStore || (this.localStore = t2.localStore, this.sharedClientState = t2.sharedClientState, this.datastore = this.createDatastore(e), this.remoteStore = this.createRemoteStore(e), this.eventManager = this.createEventManager(e), this.syncEngine = this.createSyncEngine(
      ...
      /* startAsPrimary=*/
      !t2.synchronizeTabs
    ), this.sharedClientState.onlineStateHandler = (t3) => kc2(
      this.syncEngine,
      t3,
      1
      /* OnlineStateSource.SharedClientState */
    ), this.remoteStore.remoteSyncer.handleCredentialChange = zc2.bind(null, this.syncEngine), await sc2(this.remoteStore, this.syncEngine.isPrimaryClient));
  }
  ...
  createRemoteStore(t2) {
    return e = this.localStore, n = this.datastore, s = t2.asyncQueue, i = (t3) => kc2(
      this.syncEngine,
      t3,
      0
  ...
  terminate() {
    return async function(t2) {
      ...
      ), await Nu(e), e.yu.shutdown(), // Set the OnlineState to Unknown (rather than Offline) to avoid potentially
...
var wa2 = class {
  constructor(t2, e, n, s, i) {
    this.asyncQueue = t2, this.datastore = e, this.options = n, this.updateFunction = s, this.deferred = i, this.Mc = n.maxAttempts, this.ko = new Ru(
      this.asyncQueue,
      "transaction_retry"
...
async function ya2(t2, e) {
  ...
  t2.setCredentialChangeListener((t3) => nc2(e.remoteStore, t3)), t2.setAppCheckTokenChangeListener((t3, n2) => nc2(e.remoteStore, n2)), t2.onlineComponents = e;
}
  ...
  return t2.asyncQueue.enqueue(async () => {
    ...
    return e.setNetworkEnabled(false), async function(t3) {
      ...
      e2.mu.add(
        0
        /* OfflineCause.UserDisabled */
      ), await Nu(e2), // Set the OnlineState to Offline so get()s return from cache, etc.
      e2.pu.set(
        "Offline"
        /* OnlineState.Offline */
      );
...
function Na2(t2, e) {
  ...
  return t2.asyncQueue.enqueueAndForget(async () => function(t3, e2) {
    $(t3).vu.add(e2), // Immediately fire an initial event, indicating all existing listeners
    // are in-sync.
    e2.next();
  }(await va2(t2), n)), () => {
...
var Qa2 = class {
  ...
  constructor(t2, e, n, s) {
     ...
     */
    this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new Ga({}), this._settingsFrozen = false;
  }
  /**
...
function Za(t2, e, ...n) {
  ...
  // 'undefined' and 'null'.
  1 === arguments.length && (e = Z.R()), Fa("doc", "path", e), t2 instanceof Qa2) {
    const s = rt.fromString(e, ...n);
...
function Hh(t2, e, n) {
  if (
    ...
    // FieldPath.
    (e = getModularInstance(e)) instanceof Rh
  )
...
function ml(t2) {
  return Ka("limitToLast", t2), _l._create(
    "limitToLast",
    t2,
    "L"
    /* LimitType.Last */
...
function Yl(t2, e, n, ...s) {
  ...
  (e = getModularInstance(e)) || e instanceof Rh ? Kh(r, "updateDoc", t2._key, e, n, s) : Uh(r, "updateDoc", t2._key, e);
...
!function(t2, e = true) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion(b, "3.8.4", t2), // BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
